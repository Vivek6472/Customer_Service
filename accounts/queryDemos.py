...
customerByName = Customer.objects.get(name='Peter Cat')
...
# (10) Returns all products with tag of "Summer": (Query Many to Many Fields)
productsFiltered = Product.objects.filter(tags__name="Summer")
...
# Returns: allOrders: {'Ball': 2, 'Helmet': 1}
