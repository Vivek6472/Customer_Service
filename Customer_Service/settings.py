...
SECRET_KEY = '&y2u=t(yzrxe^=@qrdpdwwybhr#yeetk%=*bpk&2s3esetp(i)'
...
INSTALLED_APPS = [
    ...
    'accounts.apps.ServiceappConfig',
    'django_filters'
]
...
2 - Login to PG Admin and Create Database
...
EMAIL_HOST = 'smtp.gmail.com'   # smtp.(email domain).com
EMAIL_PORT = 587    # Post Number of gmail.com. Check gmail smtp configuration
EMAIL_USE_TLS = True
